...
def sensitivity_results_visualization(truly_pos_positions, L_values):
    '''
    ...
    plt.savefig('MLT_document_rankings.png')  # Save the plot as a .png file
    # Show the plot
    plt.show()
...
for L_value in L_list:
    ...
    MLTresult = f'MLTresults/L = {L_value}.csv'
    ...
    rankings_df.to_csv(f'L_iterations/retvd_pos_document_rankings_L={L_value}.csv', index=False)
    ...
    LP_rankings_df.to_csv(f'L_iterations/LP_document_rankings_L={L_value}.csv', index=False)
...
#
# # # Plot the graph
sensitivity_results_visualization(pos_positions_allIters, L_list)
#
